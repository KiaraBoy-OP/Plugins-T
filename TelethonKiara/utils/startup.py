...
from TelethonKiara.DB.gvar_sql import addgvar, gvarstat
from TelethonKiara.helpers.int_str import make_int
from TelethonKiara.version import __telever__
...
<b><i>»» <u><a href='https://t.me/Its_KiaraBot'>†hê Ừʂɛɤẞø†</a></u> ««</i></b>
"""
    await client.send_file(
        ...
        caption=text,
        parse_mode="HTML",
        buttons=[[Button.url("KiaraBot Network", "https://t.me/KiaraBot_Networks")]],
    )
...
async def join_it(client):
    if client:
        try:
            await client(functions.channels.JoinChannelRequest("@Its_KiaraBot"))
