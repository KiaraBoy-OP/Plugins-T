...
async def _(event):
    ...
    await asyncio.sleep(0.5)
    await event.edit(
        "[Marr gya madarchod \nLaaa laaa......\nLa la la la](https://te.legra.ph/file/474662f27cd60c1aa5c8d.jpg)",
        link_preview=True,
    )
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1432756163:
            await event.edit(
                "This is My Master\n**How dare you trying to tell me to kill master nigger!**\n\n__Your account is on hold! Pay 99$ to my master__ [KiaraBoy](https://t.me/Kiara_X_Assistant) __to release your account__😏"
            )
        else:
