...
if Config.BOT_USERNAME and tbot:
    ...
    async def inline_handler(event):
        Kiara_X_Assistant, KIARA_USER, kiara_mention = await client_id(event, event.query.user_id)
        ...
        if event.query.user_id in auth and query == "kiarabot_help":
            ...
            if a:
                ...
                help_pic = "https://te.legra.ph/file/474662f27cd60c1aa5c8d.jpg"
            ...
            result = builder.article(
                ...
                buttons=[
                    [Button.url("📑 Repo 📑", "https://github.com/The-KiaraBot/KiaraBot")],
                    [Button.url("KiaraBot Network", "https://t.me/kiarabot_networks")],
                ],
            )
            ...
            result = builder.article(
                "@Its_KiaraBot",
                text="""**Hey! This is [Ừʂɛɤẞø†](https://t.me/its_kiarabot) \nYou can know more about me from the links given below 👇**""",
                buttons=[
                    [
                        Button.url("• Updates •", "https://t.me/Its_KiaraBot"),
                        Button.url("• Chat •", "https://t.me/kiarabot_chats"),
                    ],
                    [
                        Button.url("• Repo •", "https://github.com/The-KiaraBot/KiaraBot"),
                        Button.url("• Docs •", "https://kiarabot.tech"),
                    ],
                    [
                        Button.url("◈ KiaraBot Network ◈", "https://t.me/kiarabot_networks"),
                    ],
    ...
    async def reopn(event):
        ...
        if event.query.user_id in auth:
            ...
            await event.answer("Hello! This help menu is not for you, you can make yourself a KiaraBot and use your bot. Go to @Its_KiaraBot for more info.", cache_time=0, alert=True)
    ...
    async def send(event):
        ...
        the_plugin_file = "./TelethonKiara/plugins/{}.py".format(plugin.lower())
    ...
    async def page(event):
        ...
        if event.query.user_id in auth:
            ...
            return await event.answer(
                "Hello! This help menu is not for you, you can make yourself a KiaraBot and use your bot. Go to @Its_KiaraBot for more info.",
                cache_time=0,
                alert=True,
            )
